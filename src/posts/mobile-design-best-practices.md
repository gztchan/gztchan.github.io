---
path: "/posts/mobile-design-best-practices"
title: Mobile Design Best Practices -- Nick Babich 移动端最佳实践经验
date: "2017-06-21"
---

> 翻译自 Adobe Creative Cloud，***[Mobile Design Best Practices](https://blogs.adobe.com/creativecloud/mobile-design-best-practices/)*** by Nick Babich
...
![ec34ea6dgy1fgslww16lmj20qs1boju8.jpg](https://static.cnodejs.org/FhTcjvgt9OlMGHHz2mYgVOWJ4CcL)



### Avoid Login Walls — 避免登录墙

登录墙是要求用户登录或注册以继续进行的页面。 当应用程序首次启动或首次访问网页时，通常会显示用户登录。 请记住，注册过早可能会导致超过85％ 的用户放弃继续使用产品。
...
![ec34ea6dgy1fgslyzzxfqj20m813ihdt.jpg](https://static.cnodejs.org/FkqYqSpJdK8z1E1RZtf8X7Up5Isj)
...
![ec34ea6dgy1fgsm3lalpjj20mj0s4wnt.jpg](https://static.cnodejs.org/FqogT8AmM9VYOB9uvHxuqSSwsxoD)
...
![image.png](https://static.cnodejs.org/FsVAMzXlHSuI3bC1c0cJJcljVHGx)
...
> 分块使得表单看起来降低了页面信息加载，特别是当你从用户那里请求大量信息时。 （图片：[Murat Mutlu](https://dribbble.com/mutlu82)）
...
![](https://gztchan.oss-ap-southeast-1.aliyuncs.com/img/ec34ea6dgy1fgsmhfnuzdg20m80gonpg.gif)

> 卡片方式鼓励用户继续探索。 （图片：[Ramotion](https://www.ramotion.com/)）
...
![](https://i.loli.net/2019/06/08/5cfb6f1f5a36352327.png)
...
![image.png](https://static.cnodejs.org/Fjrh-Bm9oQ61XKxkLuh_DvDZspJQ)
...
![image.png](https://static.cnodejs.org/FnrIKr3PiLfpKWbtXxnWIiZ2Abg3)
...
- **使其可见。**
- 正如[ Jakob Nielsen](https://www.nngroup.com/articles/ten-usability-heuristics/) 所说，识别某些东西比记住它更容易。通过使操作和选项可见，最小化用户的记忆负荷。导航应随时可用，而不只是在我们预期用户需要的时候。
- **发挥视觉传达。**
- [图标](https://www.smashingmagazine.com/2016/10/icons-as-part-of-a-great-user-experience/)和其他图形元素应帮助用户了解菜单选项。想想购物车图标：它用作签出或查看项目的标识符。用户不必考虑如何导航进行购买，这个元素指示它们进行适当的操作。
- **标识当前位置。**
- “我在哪里？”是一个根本的问题，用户需要一个答案才能有效地导航。未能指出当前位置是许多应用程序中的常见问题。可以考虑位置指标。
- **使其易于交互。**
- 使菜单选项[足够大]( https://www.smashingmagazine.com/2016/11/a-quick-guide-for-designing-better-buttons/)，轻松轻拍。太小或太靠近的元素对于移动用户来说是一个巨大的挫折的来源。
- **衡量用户参与度和留存度。**
...
![image.png](https://static.cnodejs.org/FmtfuRhZk6ItXlDDyqSYp4op0bjs)

> 虽然与切换菜单（右）的界面看起来比具有分段控件的界面（左）更清晰，但后者已经获得了更多的参与度。 （图片：[Luke Wroblewski](https://www.lukew.com/ff/entry.asp?1945)）
...
[标签栏和导航栏](https://www.smashingmagazine.com/2016/11/the-golden-rules-of-mobile-navigation-design/)非常适合具有相对较少导航选项的应用程序。该模式在 iOS 和 Android 上都采用。标签是伟大的，因为它们显示所有主要的导航选项在前面，通过一个简单的点击，用户可以立即从一个视图到另一个视图。 对于这种类型的导航，我强烈建议你使用标签进行导航选项。 不要让导航成为猜测性操作。


![](https://gztchan.oss-ap-southeast-1.aliyuncs.com/img/ec34ea6dgy1fgsmsg279xg20m80go48o.gif)

> 标签栏可以通过一次点击使主导航选项可用。 （图片：[Ramotion](https://www.ramotion.com/)）



#### Segment Control — 分段控制

如果只有几个目的页面，你可以使用[分段控件](https://developer.apple.com/ios/human-interface-guidelines/ui-controls/segmented-controls/)。 与标签栏一样，所有选项都可以一次显示，只需点击一下即可访问。



![image.png](https://static.cnodejs.org/FsRpdRTIIWsS1WoQQJw2nRDeEnBh)
...
![](https://i.loli.net/2019/06/08/5cfb6f6d1802d25630.png)

> Cookly 使用全屏菜单，通过图片设置正确的心情，并刺激用户与应用程序互动。 （图片：[Patrick Wong](https://dribbble.com/patrickwong)）
...
![image.png](https://static.cnodejs.org/FkxaZFbXOcWlEDf5yQ-uEn5GTWAh)

>图片来自：[Dennis Kardys](https://www.smashingmagazine.com/2014/10/wayfinding-for-the-mobile-web/)
...
![image.png](https://static.cnodejs.org/FphAN7a8mGaP5Hg1I33HQw7aVfpQ)

> 如果搜索是您的应用程序的主要功能，请将其显示在显眼位置，因为它可能是用户发现的最快路线。 （图片：[Think with Google](https://www.thinkwithgoogle.com/)）
...
![image.png](https://static.cnodejs.org/FmQ6tOW_LKOJTJXezUfpkukc0zw6)
...
![image.png](https://static.cnodejs.org/Fheg4oXfQQUa7BBHgjelCCpQCK3a)

> 手持电话的基本方式。 （研究：[Steven Hoober](http://www.uxmatters.com/mt/archives/2013/02/how-do-users-really-hold-mobile-devices.php)）
...
![image.png](https://static.cnodejs.org/FlABtYkwiDu5MHuHuDNyO3fbARBO)
...
![image.png](https://static.cnodejs.org/FpimqyuUUe7d0D7wtX2mF3NM-qPL)

> 在 iOS 的 Pocket，所有导航控件都位于页脚中。 当手机保持竖直时，可以方便地触碰。 （图片：[Dmitry Kovalenko](https://twitter.com/JustDimon)）
...
![image.png](https://static.cnodejs.org/FmRQqt7iDdoLFxKAdqNxqIGsNKA4)

> Apple 的 Mail 应用程序中的“Edit”按钮处于难以到达的区域。



####  Appearance of Speed — 展示速度
...
![](https://gztchan.oss-ap-southeast-1.aliyuncs.com/img/ec34ea6dgy1fgso12wl26g20lp0kfnpe.gif)

> 随着内容逐渐加载，skeletion screen 会填满 UI。 （图像：[Tandem Seven](http://www.tandemseven.com/blog/how-to-use-disneys-principles-of-animation-to-improve-ux/)）
...
![](https://gztchan.oss-ap-southeast-1.aliyuncs.com/img/ec34ea6dgy1fgso0s3lkmg20m80gokjm.gif)

> 创意进度指标可以减少用户对时间的看法。 （图像：[Creative Dash](https://dribbble.com/Creativedash)）
...
![image.png](https://static.cnodejs.org/FmJmvdnPqosx9bym_o0Ecj3yNC4f)
...
![image.png](https://static.cnodejs.org/FjKMSo9SIOu5p3Tb-uGbDgP1UXlV)
...
![image.png](https://static.cnodejs.org/Fml0TVUhGM32jbNelHdRD1ITzI0q)
...
![image.png](https://static.cnodejs.org/FvenZ5z4XKewLxrIYS7UliMSxow-)
...
![image.png](https://static.cnodejs.org/FtYJZrv_EVJ5EFmwv_HIgl0MA21Y)
...
![image.png](https://static.cnodejs.org/FsXXadS_9SXGi_ki020V84NAP889)
...
![image.png](https://static.cnodejs.org/FoF2rk0PDaQsaWlWBbxEcZqJqo5o)

>  在错误的时间，错误的地方发送了很多推送通知。 （图片：[Pomegranate](http://www.pomegranate.co.uk/mobile-push-notifications/)）
...
![image.png](https://static.cnodejs.org/FgVSVoCoWvBLy0pcE-xpOYnmZVIV)

> 根据紧急情况和内容选择正确的通知类型。 （来源：[Appboy](https://www.appboy.com/)）
